package com.example.tmdb_partone.repository
...
import com.example.tmdb_partone.util.Constants.Companion.NETWORK_TIMEOUT
import com.example.tmdb_partone.util.Constants.Companion.TESTING_NETWORK_DELAY
import com.example.tmdb_partone.util.ErrorHandling
import com.example.tmdb_partone.util.ErrorHandling.Companion.ERROR_CHECK_NETWORK_CONNECTION
import com.example.tmdb_partone.util.ErrorHandling.Companion.ERROR_UNKNOWN
import com.example.tmdb_partone.util.ErrorHandling.Companion.UNABLE_TODO_OPERATION_WO_INTERNET
import com.example.tmdb_partone.util.ErrorHandling.Companion.UNABLE_TO_RESOLVE_HOST
